...
<body>
  <?php
      ...
      $sql = mysqli_query($conn, "SELECT * FROM user_login INNER JOIN admin ON user.email_user = nasabah.email_admin WHERE nasabah.email_admin = '$email'");
...
<div class="row">
  ...
  <form action="../proses/masukdatafoto.php" method="POST" enctype="multipart/form-data">
  ...
  <div class="panel panel-default">
  <!-- Default panel contents -->
  <div class="panel-heading">DATA GALERRY</div>
  <div class="panel-body">
         <table class="tabel" border="1">
       <tr><th>NO</th><th>ID FOTO</th><th>FOTO </th><th>ACTION</th></tr>
       <?php
       include "../proses/cek.php";
      $sql1 = mysqli_query($conn, "SELECT * FROM foto");
      $no=1;
      foreach ($sql1 as $row){
        $id_foto = $row['id_foto'];
        echo "<tr>
            <td>$no</td>
            <td>".$row['id_foto']."</td>
            <td><img src='../images/foto/".$row['foto']."' width='50' style='float:left;'>".$row['foto']."</td>
            <td> <a href='../admin/edit_foto.php?id=$id_foto'><img src='../images/edit.png' width='30px'>&nbsp&nbsp&nbsp&nbsp<a href='../proses/delete_foto.php?id=$id_foto'><img src='../images/delete.png' width='30px'></a></td>
              </tr>";
        $no++;
      }
      ?>
