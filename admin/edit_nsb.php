...
<!-- Form -->
  ...
  <div class="panel-heading">EDIT NASABAH</div>
  <form action="../proses/updatenasabah.php" method="POST" enctype="multipart/form-data">
  <div class="panel-body">
        <div class="row" style="margin-top:10px;font-size:13px;">
        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
            Nama<font color="red"><b>*</b></font>
          </div>
          <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
            <input type="text" name="nama" value="<?php echo $row['nama_nsb']; ?>" class="form-control" required >
          </div>
        </div>
         <div class="row" style="margin-top:10px;font-size:13px;">
        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
            Email<font color="red"><b>*</b></font>
          </div>
          <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
            <input name="email" class="form-control" required value="<?php echo $row['email_user']; ?>">
          </div>
        </div>
        <div class="row" style="margin-top:10px;font-size:13px;">
        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
          ...
          <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
            <input name="telp" class="form-control" required value="<?php echo $row['telp_nsb']; ?>">
          </div>
        </div>
       <div class="row" style="margin-top:10px;font-size:13px;">
          <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
          ...
          <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
            <input type="text"  name="kerja" value="<?php echo $row['pekerjaan_nsb']; ?>"class="form-control" required>
          </div>
        </div>
        <div class="row" style="margin-top:10px;font-size:13px;">
        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
          ...
          <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
            <input type="text" name="alamat" value="<?php echo $row['alamat_nsb']; ?>"class="form-control" required >
          </div>
        </div>
         <div class="row" style="margin-top:10px;font-size:13px;">
        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
          ...
          <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
            <input type="text" name="kab" value="<?php echo $row['kabkot_nsb']; ?>" class="form-control" required >
          </div>
        </div>
        <div class="row" style="margin-top:10px;font-size:13px;">
        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
          ...
          <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
            <input type="text" name="jk" value="<?php echo $row['jk_nsb']; ?>" class="form-control" required >
        </div>
      </div>
       <div class="row" style="margin-top:10px;font-size:13px;">
          <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
            Tanggal Lahir <font color="red"><b>*</b></font>
          </div>
          <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
            <input type="text"  name="tgl" value="<?php echo $row['tgllahir_nsb']; ?>"class="form-control" required>
          </div>
        </div>
        <div class="row" style="margin-top:10px;font-size:13px;">
          <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
            Tempat Lahir <font color="red"><b>*</b></font>
          </div>
          <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
            <input type="text"  name="tmp" value="<?php echo $row['tmplahir_nsb']; ?>"class="form-control" required>
          </div>
        </div>
        <div class="row" style="margin-top:10px;font-size:13px;">
          <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
          ...
          <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
            <input type="text"  name="pass" value="<?php echo $row['password_user']; ?>"class="form-control" required>
          </div>
        </div>
      <div class="row" style="margin-top:10px;font-size:13px;">
