...
<!-- breadcrumb -->
<ol class="breadcrumb">
  <li><a href="berita.php">Admin LPDKU</a></li>
  ...
  <div class="panel-body">
      <div class="row" style="margin-top:10px;font-size:13px;">
        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
            ID Berita<font color="red"><b>*</b></font>
          </div>
          <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
            <input type="text" name="id" value="<?php echo $row['id_berita']; ?>"class="form-control" required readonly>
          </div>
        </div>
        <div class="row" style="margin-top:10px;font-size:13px;">
        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
          ...
          <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
            <input type="text" name="judul" value="<?php echo $row['judul_berita']; ?>" class="form-control" required >
          </div>
        </div>
         <div class="row" style="margin-top:10px;font-size:13px;">
        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
          ...
          <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
            <textarea name="isi" class="form-control" style="height:200px;" required> <?php echo $row['isi_berita']; ?></textarea>
          </div>
        </div>
        <div class="row" style="margin-top:10px;font-size:13px;">
          <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
          ...
          <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
            ...
            <input type="file"  name="gambar" align="center" style="padding-left:5px;">
          </div>
          </div>
        </div>
       <div class="row" style="margin-top:10px;font-size:13px;">
          <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
            Tanggal Berita <font color="red"><b>*</b></font>
          </div>
          <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
            <input type="text"  name="tgl" value="<?php echo $row['tgl_berita']; ?>"class="form-control" required>
          </div>
        </div>
      <div class="row" style="margin-top:10px;font-size:13px;">
