...
<!-- breadcrumb -->
<ol class="breadcrumb">
  <li><a href="pembayaranlistrik.php">Nasabah LPDKU</a></li>
...
<?php
  ...
  <div class="row">
    ...
    <div class="panel-heading">LISTRIK</div>
    <!-- Default panel contents -->
    <div class="panel-body">
      <form action="../proses/masukdatalistrik.php" method="POST" onsubmit="return cek()" enctype="multipart/form-data">
        ...
        <div class="row" style="margin-top:10px;font-size:13px;">
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            No Meteran <font color="red"><b>*</b></font>
          </div>
          <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
            <input type="text" name="no_meteran" class="form-control" >
          </div>
        </div>
         <div class="row" style="margin-top:10px;font-size:13px;">
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            Nominal <font color="red"><b>*</b></font>
          </div>
          <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
